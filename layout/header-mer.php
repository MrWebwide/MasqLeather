<div class="offcanvas_menu">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="offcanvas_menu_wrapper" style="background-color: rgb(48, 48, 48) !important;">
...
?>
                                    <li><a href="homedecor-category.php?kategori=<?= urlencode($adi) ?>">
                                            <?= $adi ?>
                                        </a></li>
                                    <?php } ?>
...
$urun_sayisi = $hizmetka['urun_sayisi'];
?>
                                <li><a href="jewelry-category.php?kategori=<?= urlencode($adi) ?>">
                                        <?= $adi ?>
                                    </a></li>
                                <?php } ?>
                        ...
                        <li class="menu-item-has-children"><a href="index.php" class="ripple-link12">Masq Leather</a></li>
                        <li class="menu-item-has-children">
                            <a href="blogmercantile.php">blog</a>

                        </li>

                        <li>
                        <div class="search-bar">
                            <form action="product-mercantile.php" method="GET" >
...
<!--offcanvas menu area end-->
 <!--header area start-->
 <header class="header_section2 " style="">
    <div class="container">
        <div class="row" >
            <div class="col-12">
                <div class="main_header d-flex justify-content-between align-items-center">
                    <div class="header_logo logo1">
                        <a href="index-2.php" class="ripple-link2" ><img src="assets/img/logo/mercantil.png"
                                alt=""></a>
                    </div>
                ...
                ">
                        <nav>
                            <ul class="d-flex">
                                <li><a class="active" href="index-2.php">Main Page</a></li>
                               
                                <li><a href="homedecor.php">Home Decor</a>
...
foreach ($hizmetkategori as $hizmetka) {
    ...
    $urun_sayisi = $hizmetka['urun_sayisi'];
    ?>          
                                <li><a href="homedecor-category.php?kategori=<?= urlencode($adi) ?>"><?= $adi ?></a></li>
                                <?php } ?>    
                                ...
                                <li><a href="jewelry.php">Jewelry</a>
...
foreach ($hizmetkategori as $hizmetka) {
    ...
    $urun_sayisi = $hizmetka['urun_sayisi'];
    ?>          
                <li><a href="jewelry-category.php?kategori=<?= urlencode($adi) ?>"><?= $adi ?></a></li>                                    <?php } ?>
                                ...
                                <li><a href="index.php" class="ripple-link">MASQ LEATHER</a>
                                   
                                </li>

                                <li><a href="blogmercantile.php">blog</a>

                                </li>

                                <li class="header_search_btn custom-margin"><a href="#"><img width="40px"
                                                src="assets/img/animated-icon/white-magnifier.png" alt=""></a></li>

                        <li class="shopping_cart custom-margin"><a href="#"><img width="40px"
                                    src="assets/img/animated-icon/shopping-cartwww.png" alt=""></a></li>
                                            <li class="account_link_menu custom-margin">
                                                <div class="link_container" style="background-color: rgb(48, 48, 48) !important;">
                                                <?php if (isset($_SESSION['adsoyad'])) : ?>
            <a href="#.php">
                <div class="flex-container">
                    <div class="icon_container">
                        <img width="50px" src="assets/img/animated-icon/accountww.png" alt="">
                    </div>
                    <div class="text_container">
                        <span style="color:white;"><?php echo $_SESSION['adsoyad']; ?></span>
                    </div>
                </div>
            </a>
            <?php
        ...
        <?php else : ?>
            <a href="auth/signin.php">
                <div class="flex-container">
                    ...
                    <div class="text_container">
                        <span style="color:white;">Log-in / Register</span>
                    </div>
                </div>
            </a>
        <?php endif; ?>
                    ...
                    <!---
                    <div class="header__ridebar d-flex ">
                   ...
                   <li class="account_link_menu custom-margin">
    <div class="link_container" style="border-radius:unset; background-color: rgb(48, 48, 48) !important;">
        <?php if (isset($_SESSION['adsoyad'])) : ?>
            <a href="#.php" class="flex-container">
                <div class="icon_container">
                    <img width="50px" src="assets/img/animated-icon/accountww.png" alt="">
                </div>
                <div class="text_container" style="padding-bottom:10px;">
                    <span style="color: white;"><?php echo $_SESSION['adsoyad']; ?></span>
                </div>
            </a>
            <?php
...
?> 
        <?php else : ?>
            <a href="auth/signin.php" class="flex-container">
                <div class="icon_container">
                    <img width="50px" src="assets/img/animated-icon/accountww.png" alt="">
                </div>
                <div class="text_container" style="padding-bottom:10px;">
        ...
        <?php endif; ?>
                       ...
                       <li class="shopping_cart custom-margin" style="list-style-type: none;"><a href="#" style="margin-right: 1px;"><img width="40px"
                                           src="assets/img/animated-icon/shopping-cartwww.png" alt=""></a></li>
...
<style>
    .main_menu nav>ul>li ul.sub_menu {
        background-image: url(./assets/img/shutterstock/stock-photo-black-dark-and-gray-abstract-cement-wall-and-studio-room-gradient-background-1016583874-transformed.jpeg) !important;
    }
...
if (isset($_SESSION['id'])) {
    ...
    if ($stmt->rowCount() == 0) {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo '<a href="#"><img src="admin/resimler/' . $productImage . '" alt=""></a>';
            echo '</div>';
            echo '<div class="cart_info">';
            echo '<div class="close-sec d-flex">';
            echo '<a href="' . $product_link . '">' . $productName . '</a>';
