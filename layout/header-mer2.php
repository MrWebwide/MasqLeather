                    ...
                    <div id="menu" class="text-left ">
                        <ul class="offcanvas_main_menu">
                            <li class="menu-item-has-children active">
                                <a href="<?=$basePath?>index-2.php">Home</a>
                            </li>
...
foreach ($hizmetkategori as $hizmetka) {
    ...
    ?>  
                                    <li><a href="<?=$basePath?>homedecor-category.php?kategori=<?= urlencode($adi) ?>">
                                            <?= $adi ?>
                                        </a></li>
                                    <?php } ?>
...
foreach ($hizmetkategori as $hizmetka) {
    ...
    $urun_sayisi = $hizmetka['urun_sayisi'];
    ?>   
                                <li><a href="<?=$basePath?>jewelry-category.php?kategori=<?= urlencode($adi) ?>">
                                        <?= $adi ?>
                                    </a></li>
                                <?php } ?>
                        ...
                        <li class="menu-item-has-children"><a href="<?=$basePath?>index.php" class="ripple-link12">Masq Leather</a></li>
                        <li class="menu-item-has-children">
                            <a href="<?=$basePath?>blogmercantile.php">blog</a>

                        </li>

                        <li>
                        <div class="search-bar">
                            <form action="<?=$basePath?>product-mercantile.php" method="GET" >
            ...
            <div class="col-12">
                <div class="main_header d-flex justify-content-between align-items-center">
                    <div class="header_logo logo1">
                        <a href="<?=$basePath?>index-2.php" ><img src="<?=$basePath?>assets/img/logo/mercantil.png"
                                alt=""></a>
                    </div>
                ...
                ">
                        <nav>
                            <ul class="d-flex">
                                <li><a class="active" href="<?=$basePath?>index-2.php">Main Page</a></li>
                               
                                <li><a href="<?=$basePath?>homedecor.php">Home Decor</a>
...
foreach ($hizmetkategori as $hizmetka) {
    ...
    $urun_sayisi = $hizmetka['urun_sayisi'];
    ?>          
                                <li><a href="<?=$basePath?>homedecor-category.php?kategori=<?= urlencode($adi) ?>"><?= $adi ?></a></li>
                                <?php } ?>    
                                ...
                                <li><a href="<?=$basePath?>jewelry.php">Jewelry</a>
...
foreach ($hizmetkategori as $hizmetka) {
    ...
    $urun_sayisi = $hizmetka['urun_sayisi'];
    ?>          
                <li><a href="<?=$basePath?>jewelry-category.php?kategori=<?= urlencode($adi) ?>"><?= $adi ?></a></li>                                    <?php } ?>
                                ...
                                <li><a href="<?=$basePath?>index.php" class="ripple-link">MASQ LEATHER</a>
                                   
                                </li>

                                <li><a href="<?=$basePath?>blogmercantile.php">blog</a>
            ...
            <a href="#.php">
                <div class="flex-container">
                    <div class="icon_container">
                        <img width="50px" src="<?=$basePath?>assets/img/animated-icon/accountww.png" alt="">
                    </div>
...
?> 
    ...
    <div class="link_container" style="border-radius:unset; background-color: rgb(48, 48, 48) !important;">
        <?php if (isset($_SESSION['adsoyad'])) : ?>
            <a href="#.php" class="flex-container" style="display:flex !important;">
                <div class="icon_container">
                    <img width="50px" src="<?=$basePath?>assets/img/animated-icon/accountww.png" alt="">
                </div>
...
?> 
        <?php else : ?>
            <a href="<?=$basePath?>auth/signin.php" class="flex-container" style="display:flex !important;">
                <div class="icon_container">
                    <img width="50px" src="<?=$basePath?>assets/img/animated-icon/accountww.png" alt="">
                </div>
                <div class="text_container" style="padding-bottom:10px;">
