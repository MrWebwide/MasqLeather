...
$stmt = $db->prepare("SELECT * FROM accessories WHERE id = ?");
$stmt->execute([$id]);
$urunler = $stmt->fetch();

$stmt = $db->prepare("SELECT * FROM accessories_img WHERE urun_id = ?");
$stmt->execute([$id]);
...
$productOptions = masq_get_product_options($db, (int) $id, 'accessories');

$pageTitle       = $yazi['yazi1'] ?? 'Accessories';
...
<body>
    ...
    <div class="product-section" style="padding-left: 15vw;">
        ...
        <?php
$haberg = $db->query("SELECT * FROM bloggelen WHERE durum = 'on' AND yorumid = $id AND tur = 'accessories' ORDER BY id DESC");
...
function getDurumById($urun_id) {
    ...
    $stmt = $db->prepare("SELECT durum FROM accessories WHERE id = ?");
...
<div class="coloropt d-flex">
    <?php if (!empty($urunler['yazi10']) && getDurumById($urunler['yazi10']) === 'on'): ?>
        <a href="./accessories-detail.php?id=<?=$urunler['yazi10']?>" class="color_option"><img src="./admin/resimler/<?=$urunler['yazi15']?>" alt=""></a>
    <?php endif; ?>
    <?php if (!empty($urunler['yazi11']) && getDurumById($urunler['yazi11']) === 'on'): ?>
        <a href="./accessories-detail.php?id=<?=$urunler['yazi11']?>" class="color_option"><img src="./admin/resimler/<?=$urunler['yazi16']?>" alt=""></a>
    <?php endif; ?>
    <?php if (!empty($urunler['yazi12']) && getDurumById($urunler['yazi12']) === 'on'): ?>
        <a href="./accessories-detail.php?id=<?=$urunler['yazi12']?>" class="color_option"><img src="./admin/resimler/<?=$urunler['yazi17']?>" alt=""></a>
    <?php endif; ?>
    <?php if (!empty($urunler['yazi13']) && getDurumById($urunler['yazi13']) === 'on'): ?>
        <a href="./accessories-detail.php?id=<?=$urunler['yazi13']?>" class="color_option"><img src="./admin/resimler/<?=$urunler['yazi18']?>" alt=""></a>
    <?php endif; ?>
    <?php if (!empty($urunler['yazi14']) && getDurumById($urunler['yazi14']) === 'on'): ?>
        <a href="./accessories-detail.php?id=<?=$urunler['yazi14']?>" class="color_option"><img src="./admin/resimler/<?=$urunler['yazi19']?>" alt=""></a>
    <?php endif; ?>
</div>
                        ...
                        <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                            ...
                            <div class="addreview">
                                ...
                                <div class="product_review_form">
                                    <form method="post" action="" id="comment-form2" data-tur="accessories" novalidate>
                                        <div class="row">
    ...
    <div class="container">
        ...
        <div class="related_product_inner">
            <div class="row">
                ...
                $hizmett = $db->prepare("SELECT * FROM accessories WHERE kategori = ? AND id != ? AND durum = 'on' ORDER BY RAND() LIMIT 4");
                            ...
                            <article class="single_product">
                                <figure>
                                    <div class="product_thumb">
                                        <a href="accessories-detail.php?id=<?= $hizmet['id'] ?>"><img
                                                src="admin/resimler/<?=$hizmet['resim']?>" alt=""></a>

                                    </div>
                                    <figcaption class="product_content">
                                        <h4><a href="accessories-detail.php?id=<?= $hizmet['id'] ?>">
                                                <?=$hizmet['adi']?>
                                            </a></h4>
                                        <div class="price_box">
                                            <span class="current_price">$
