...
$pageTitle       = 'Masq Mercantile - Search';
$pageDescription = '';
$pageKeywords    = '';
?>
<!DOCTYPE html>
...
foreach ($hizmetkategori as $hizmetka) {
    ...
    ?>        
                                    <li><a href="homedecor-category.php?kategori=<?= urlencode($adi) ?>"><?= $adi ?>(<?= $urun_sayisi ?>)</a></li>
                                    <?php } ?>
                                    </ul>
                                </div>
...
foreach ($hizmetkategori as $hizmetka) {
    ...
    $urun_sayisi = $hizmetka['urun_sayisi'];
    ?>         
                                    <li><a href="jewelry-category.php?kategori=<?= urlencode($adi) ?>"><?= $adi ?>(<?= $urun_sayisi ?>)</a></li>
