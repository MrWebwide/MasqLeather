...
// MAS-90: Arama artık isim + açıklama (yazi3) + kategori'de VE markalar arası (4 ürün
// tablosu) çalışıyor. Sadece aktif (durum='on') ürünler. Tablo→detay eşlemesi $searchTables.
$searchTables = [
        ...
        <article class="single_product">
            <figure>
                <div class="product_thumb" onmouseover="showSecondImage(this)" onmouseout="hideSecondImage(this)">
                    <?php $detailPage = $searchTables[$urun['tablo']] ?? 'bagpurses-detail.php'; ?>
