...
if($_GET['sil']){
	$idd=intval($_GET['sil']);
	 ...
	 $resim_sorgu=$db->query("select * from dil where id='$idd'")->fetch(PDO::FETCH_ASSOC);
	 unlink('resimler/'.$resim_sorgu['resim']);
	$simdi=$db->query("delete from dil where id='$idd'")->fetch(PDO::FETCH_ASSOC);
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Dil Listele</h5>
                           
                                <a href="dil-ekle.php"  class="btn btn-primary m-b-md">Dil Ekle</a>
                                <table class="table invoice-table">
                                            <thead>
                                              <tr>
                                                <th scope="col">Dil Sırası</th>
                                                <th scope="col">Dil Resmi</th>
                                            ...
                                            <tbody>
                                            <?php
                                            $urunlistele = $db->query("select * from dil order by id desc",PDO::FETCH_ASSOC);
