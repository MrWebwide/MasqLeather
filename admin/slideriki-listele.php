...
if($_GET['sil']){
	$idd=intval($_GET['sil']);
	 ...
	 $resim_sorgu=$db->query("select * from slideriki where id='$idd'")->fetch(PDO::FETCH_ASSOC);
	 unlink('resimler/'.$resim_sorgu['resim']);
	$simdi=$db->query("delete from slideriki where id='$idd'")->fetch(PDO::FETCH_ASSOC);
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body table-responsive">
                                ...
                                <a href="slideriki-ekle.php"  class="btn btn-primary m-b-md">Slider Ekle</a>
                                <table class="table invoice-table ">
                                            ...
                                            <tbody>
                                            <?php
                                            $urunlistele = $db->query("select * from slideriki order by id desc",PDO::FETCH_ASSOC);
