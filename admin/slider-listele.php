                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body table-responsive">
                                ...
                                <a href="slider-ekle.php"  class="btn btn-primary m-b-md">Slider Ekle</a>
                                <table class="table invoice-table ">
                                            ...
                                            <tbody>
                                            <?php
                                            $urunlistele = $db->query("select * from slider order by id desc",PDO::FETCH_ASSOC);
