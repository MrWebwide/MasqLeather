...
if($_POST['kaydet'] and $_GET['islem']==''){
	...
	else
	{
	 ...
	 $simdi = $db->prepare("insert into fiyatlar set adi=:adi,resim=:resim,durum=:durum,onaciklama=:onaciklama,kategori=:kategori,aciklama=:aciklama,buton=:buton,linki=:linki,yazi1=:yazi1,yazi2=:yazi2,yazi3=:yazi3,yazi4=:yazi4,yazi5=:yazi5,yazi6=:yazi6,sira=:sira");
	...
	if($ekle){
		  ...
		  $sonid=$db->query("select * from fiyatlar order by id desc")->fetch(PDO::FETCH_ASSOC);
...
if($_POST['kaydet'] and $_GET['islem']=='duzenle'){
	...
	if(isset($_POST['img'])){
	 ...
	 $simdi1 = $db->prepare("update fiyatlar set adi=:adi,resim=:resim,durum=:durum,onaciklama=:onaciklama,kategori=:kategori,aciklama=:aciklama,buton=:buton,linki=:linki,yazi1=:yazi1,yazi2=:yazi2,yazi3=:yazi3,yazi4=:yazi4,yazi5=:yazi5,yazi6=:yazi6,sira=:sira where id=:id");
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Fiyat   Ekle</h5>
                                      ...
                                      <a href="fiyat-listele.php"  class="btn btn-primary m-b-md">Fiyat Listele</a>
									...
									<div class="form-floating mb-3">
                                     ...
                                     <!--      <div class="form-floating mb-3">
                                        ...
                                        <label for="floatingInput">Fiyat  </label>
                                         ...
                                         <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" name="yazi2" placeholder="Süresi" value="<?=$guncelle['yazi2']?>">
                                        <label for="floatingInput">Süresi</label>
                                      </div>
