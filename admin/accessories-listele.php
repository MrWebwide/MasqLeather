...
if($_GET['sil']){
	$idd=intval($_GET['sil']);
	 ...
	 $resim_sorgu=$db->query("select * from accessories where id='$idd'")->fetch(PDO::FETCH_ASSOC);
	$simdi=$db->query("delete from accessories where id='$idd'")->fetch(PDO::FETCH_ASSOC);
          ...
          <div class="col">
            <div class="card">
              <div class="card-body" style="overflow:scroll">
                ...
                <a href="accessories-ekle.php" class="btn btn-primary m-b-md">Add Product</a>
                <table class="table invoice-table">
                  ...
                  <tbody>
                    <?php
                                            $urunlistele = $db->query("select * from accessories order by sira asc",PDO::FETCH_ASSOC);
...
?>
                      ...
                      <td><img id="my-image" src="resimler/<?=$urungoster['resim']?>" alt="<?=$urungoster['adi']?>"> </td>
                      <td><span class="badge bg-primary">
                          <?=$urungoster['eklenme_tarihi']?>
                        </span></td>
                      <td>
                        <a href="accessories-ekle.php?islem=duzenle&id=<?=$urungoster['id']?>"><svg
                        ...
                        <a href="../menu.php" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="24"
...
function dragEnd() {
  ...
  xhr.open('POST', 'update_order_acc.php', true);
