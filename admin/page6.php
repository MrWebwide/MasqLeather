...
$id = 1;
	 ...
	 $simdi = $db->prepare("update sayac6 set yazi1=:yazi1,sayi1=:sayi1,icon1=:icon1,yazi2=:yazi2,sayi2=:sayi2,icon2=:icon2,yazi3=:yazi3,sayi3=:sayi3,icon3=:icon3,yazi4=:yazi4,yazi5=:yazi5,yazi6=:yazi6,yazi7=:yazi7,yazi8=:yazi8,yazi9=:yazi9,sayi4=:sayi4,icon4=:icon4,resim4=:resim4,resim3=:resim3,resim2=:resim2,resim1=:resim1");
	...
	$guncelle = $db->query("select * from sayac6 where id='1'")->fetch(PDO::FETCH_ASSOC);
                ...
                <div class="main-wrapper">
                    <div class="row">
                        <div class="col">
                            <div class="card">
                            <div class="card-body">
                                    <h5 class="card-title">Refund Section </h5>
