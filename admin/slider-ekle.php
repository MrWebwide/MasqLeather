...
$klasord="resimler/";
	...
	else
	{
	 ...
	 $simdi = $db->prepare("insert into slider set adi=:adi,sira=:sira,resim=:resim,resim1=:resim1,buton=:buton,linki=:linki,durum=:durum,aciklama=:aciklama,yazi1=:yazi1,yazi2=:yazi2,yazi3=:yazi3,yazi4=:yazi4,yazi5=:yazi5");
...
if($_POST['kaydet'] and $_GET['islem']=='duzenle'){
	...
	else
	{
	 ...
	 $simdi1 = $db->prepare("update slider set adi=:adi,sira=:sira,resim=:resim,resim1=:resim1,buton=:buton,linki=:linki,durum=:durum,yazi1=:yazi1,yazi2=:yazi2,yazi3=:yazi3,yazi4=:yazi4,yazi5=:yazi5,aciklama=:aciklama where id=:id");
...
if($_GET['islem']=='duzenle'){
	...
	$guncelle = $db->query("select * from slider where id='$gid'")->fetch(PDO::FETCH_ASSOC);
}
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Slider  Ekle</h5>
                                      <a href="slider-listele.php"  class="btn btn-primary m-b-md">Slider Listele</a>
                                    ...
                                    <div class="form-floating mb-3">
                                     ...
                                     <div class="form-floating mb-3">
                                      ...
                                      <div class="form-floating mb-3">
										...
										-->
									  <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" name="yazi1" placeholder="Slider Alt Başlığı" value="<?=$guncelle['yazi1']?>">
                                        <label for="floatingInput">Slider Alt Başlığı</label>
                                      </div>
										<!--
									  <div class="form-floating mb-3">
