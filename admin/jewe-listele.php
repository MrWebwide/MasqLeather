...
if($_GET['sil']){
	$idd=intval($_GET['sil']);
	 ...
	 $resim_sorgu=$db->query("select * from jewe where id='$idd'")->fetch(PDO::FETCH_ASSOC);

	$simdi=$db->query("delete from jewe where id='$idd'")->fetch(PDO::FETCH_ASSOC);
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body"style="overflow:scroll">
                                ...
                                <a href="jewe-ekle.php"  class="btn btn-primary m-b-md">Add Product</a>
                                <table class="table invoice-table">
                                            ...
                                            <tbody>
                                            <?php
                                            $urunlistele = $db->query("select * from jewe order by sira asc",PDO::FETCH_ASSOC);
...
function dragEnd() {
  ...
  xhr.open('POST', 'update_order_jewelry.php', true);
