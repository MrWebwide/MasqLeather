...
$klasor="resimler/";
	...
	{
		$duzenlenecek_id = 1;
		$ayar_kaydi = $db->query("SELECT * FROM sayac WHERE id = '$duzenlenecek_id'")->fetch(PDO::FETCH_ASSOC);
  ...
  $resim_tmp3 = $_FILES['resim1']['tmp_name'];
	...
	else
	{
	 ...
	 $simdi = $db->prepare("update sayac set yazi1=:yazi1,sayi1=:sayi1,icon1=:icon1,yazi2=:yazi2,sayi2=:sayi2,icon2=:icon2,yazi3=:yazi3,sayi3=:sayi3,icon3=:icon3,yazi4=:yazi4,yazi5=:yazi5,yazi6=:yazi6,yazi7=:yazi7,yazi8=:yazi8,yazi9=:yazi9,sayi4=:sayi4,icon4=:icon4,resim4=:resim4,resim3=:resim3,resim2=:resim2,resim1=:resim1");
	...
	$guncelle = $db->query("select * from sayac where id='1'")->fetch(PDO::FETCH_ASSOC);
...
<head>
        ...
        <title>Main Page | <?=$ayar['site_title']?></title>
                                ...
                                <div class="card-body">
                                    ...
                                    <?=$mesaj?>
                                     ...
                                     <!--  <div class="form-floating mb-3">
                                      ...
                                      <div class="form-floating mb-3">
                                        ...
                                        <label for="floatingInput">Header 1</label>
                                      </div> 
                                 ...
                                 <textarea  class="ckeditor" name="yazi1"  rows="10"><?=$guncelle['yazi1']?></textarea>
                                     ...
                                     <!--   
                                        ...
                                        <label for="floatingInput">Header 2</label>
                                      </div> 
                                      
                                      <div class="mb-3">
                                 
                                 <textarea  class="ckeditor" name="yazi2"  rows="10"><?=$guncelle['yazi2']?></textarea>
                            </div>

                                      <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" name="sayi4" placeholder="Hakkımızda" value="<?=$guncelle['sayi4']?>">
                                        <label for="floatingInput">Header 3</label>
                                      </div> 
                                      
                                      <div class="mb-3">
                                 
                                 <textarea  class="ckeditor" name="yazi4"  rows="10"><?=$guncelle['yazi4']?></textarea>
                            </div>
