...
if($_GET['sil']){
	$idd=intval($_GET['sil']);
	 ...
	 $resim_sorgu=$db->query("select * from sc where id='$idd'")->fetch(PDO::FETCH_ASSOC);
	 unlink('resimler/'.$resim_sorgu['resim']);
	$simdi=$db->query("delete from sc where id='$idd'")->fetch(PDO::FETCH_ASSOC);
...
<head>
        ...
        <title>SC Listele | <?=$ayar['site_title']?></title>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body" style="overflow:scroll">
                                <h5 class="card-title">SC Listele</h5>
                           
                                <a href="sc-ekle.php"  class="btn btn-primary m-b-md">Add Comment</a>
                                <table class="table invoice-table">
                                            <thead>
                                              <tr>
                                                <th scope="col">Comment Order</th>
                                                <th scope="col">Comment Picture</th>
                                            ...
                                            <tbody>
                                            <?php
                                            $urunlistele = $db->query("select * from sc order by sira asc",PDO::FETCH_ASSOC);
    ...
    <?php $reorderTable='sc'; include("include/reorder_script.php"); ?>
          </body>
