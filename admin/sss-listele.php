...
<head>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">S.S.S Listele</h5>
                           
                                <a href="sss-ekle.php"  class="btn btn-primary m-b-md">S.S.S Ekle</a>
                                <table class="table invoice-table">
                                            <thead>
                                              <tr>
                                                <th scope="col">S.S.S Sırası</th>
                                             
                                                <th scope="col">S.S.S Adı</th>
                                            ...
                                            <tbody>
                                            <?php
                                            $urunlistele = $db->query("select * from sss order by sira asc",PDO::FETCH_ASSOC);
    ...
    <?php $reorderTable='sss'; include("include/reorder_script.php"); ?>
    </body>
