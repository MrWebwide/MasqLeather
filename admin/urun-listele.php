                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body"style="overflow:scroll">
                                ...
                                <a href="urun-ekle.php"  class="btn btn-primary m-b-md">Add Product</a>
                                <table class="table invoice-table">
                                            ...
                                            <tbody>
                                            <?php
                                            $urunlistele = $db->query("select * from urunler order by sira asc",PDO::FETCH_ASSOC);
...
function dragEnd() {
  ...
  xhr.open('POST', 'update_order_bag.php', true);
