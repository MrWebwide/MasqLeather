...
if($_GET['sil']){
	$idd=intval($_GET['sil']);
	 ...
	 $resim_sorgu=$db->query("select * from bloglarmer where id='$idd'")->fetch(PDO::FETCH_ASSOC);
	 unlink('resimler/'.$resim_sorgu['resim']);
	$simdi=$db->query("delete from bloglarmer where id='$idd'")->fetch(PDO::FETCH_ASSOC);
...
<head>
        ...
        <title>Blog  Listele | <?=$ayar['site_title']?></title>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body"style="overflow:scroll">
                                ...
                                <a href="blogmer-ekle.php"  class="btn btn-primary m-b-md">Add Blog</a>
                                <table class="table invoice-table">
                                            <thead>
                                              <tr>
                                                <th scope="col">Blog Order</th>
                                            ...
                                            <tbody>
                                            <?php
                                            $urunlistele = $db->query("select * from bloglarmer order by sira asc",PDO::FETCH_ASSOC);
    ...
    <?php $reorderTable='bloglarmer'; include("include/reorder_script.php"); ?>
    </body>
