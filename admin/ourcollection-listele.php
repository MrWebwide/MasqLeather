...
if($_GET['sil']){
	$idd=intval($_GET['sil']);
	 ...
	 $resim_sorgu=$db->query("select * from ourcollection where id='$idd'")->fetch(PDO::FETCH_ASSOC);
	 unlink('resimler/'.$resim_sorgu['resim']);
	$simdi=$db->query("delete from ourcollection where id='$idd'")->fetch(PDO::FETCH_ASSOC);
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body"style="overflow:scroll">
                                <h5 class="card-title">Our Collection Listele</h5>
                           
                                <a href="ourcollection-ekle.php"  class="btn btn-primary m-b-md">Our Collection Ekle</a>
                                <table class="table invoice-table">
                                            <thead>
                                              <tr>
                                              <th scope="col">Change Order</th>
                                                <th scope="col">Our Collection Order</th>
                                               
                                                <th scope="col">Our Collection Name</th>
                                                <th scope="col">Our Collection Picture</th>
                                            ...
                                            <tbody>
                                            <?php
                                            $urunlistele = $db->query("select * from ourcollection order by sira asc",PDO::FETCH_ASSOC);
...
function dragEnd() {
  ...
  xhr.open('POST', 'update_order_ourc.php', true);
  ...
  xhr.send(JSON.stringify(productData));
                          ...
                          <style>
                            .selected-row {
      box-shadow: 0px 0px 10px 3px rgba(0, 0, 255, 0.7); /* Mavi gölgeli bir çerçeve ekliyoruz */
    transform: translateY(-5px); /* Biraz yukarıya kalkma efekti için */
  }
