...
$klasord="resimler/";
	...
	$simdi = $db->prepare("insert into referanslar set adi=:adi,sira=:sira,resim=:resim,resim1=:resim1,kategori=:kategori,durum=:durum,onaciklama=:onaciklama,aciklama=:aciklama,yazi2=:yazi2,yazi1=:yazi1,seo=:seo,tur=:tur,eklenme_tarihi=:eklenme_tarihi");
...
$yeni =$sonid['id'];
    if(isset($_POST['img'])){
		...
		<div class='alert alert-warning alert-dismissible fade show' role='alert'>
                          <strong>Haber Başarıyla Eklendi!</strong>
...
if($_POST['kaydet'] and $_GET['islem']=='duzenle'){
	...
	if(isset($_POST['img'])){
	 ...
	 $simdi1 = $db->prepare("update referanslar set adi=:adi,sira=:sira,resim=:resim,resim1=:resim1,kategori=:kategori,durum=:durum,onaciklama=:onaciklama,yazi2=:yazi2,yazi1=:yazi1,aciklama=:aciklama,seo=:seo,tur=:tur,guncelleme_tarihi=:guncelleme_tarihi where id=:id");
	...
	if($ekle1){
		...
		<div class='alert alert-warning alert-dismissible fade show' role='alert'>
                          <strong>Haber Başarıyla Güncellendi!</strong> 
                          <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                        </div>
...
<head>
        ...
        <title>Özel Menü Ekle | <?=$ayar['site_title']?></title>
                ...
                <div class="main-wrapper">
                    <div class="row">
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Köfte Menü  Ekle</h5>
                                      <a href="referans-listele.php"  class="btn btn-primary m-b-md">Köfte Menü Listele</a>
