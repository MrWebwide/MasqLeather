...
function updateDurum() {
    ...
    durumInput.value = "accessories-category.php?kategori=" + urlUyumluMetin;
}
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body table-responsive">
									...
									<a href="bolge-kat-listele.php"  class="btn btn-primary m-b-md">Kategori Listele</a>

                                    <p class="card-description"> all of the available spaces.</p>
                                    <?=$mesaj?>
                                    ...
                                    <div class="form-floating mb-3">
                                        ...
                                        <label for="floatingInput">Bölge Kategori sırası</label>
                                           ...
                                           <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput1" name="adi" placeholder="Kategori Adı" oninput="updateDurum()" value="<?=$guncelle['adi']?>">
