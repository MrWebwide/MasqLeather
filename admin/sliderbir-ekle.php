...
$klasord="resimler/";
	...
	else
	{
	 ...
	 $simdi = $db->prepare("insert into sliderbir set adi=:adi,sira=:sira,resim=:resim,resim1=:resim1,buton=:buton,linki=:linki,durum=:durum,aciklama=:aciklama,yazi1=:yazi1,yazi2=:yazi2,yazi3=:yazi3,yazi4=:yazi4,yazi5=:yazi5");
...
if($_POST['kaydet'] and $_GET['islem']=='duzenle'){
	...
	if(empty($resim_tmp))
	{
		...
		$ayar_kaydi = $db->query("SELECT * FROM sliderbir WHERE id = '$id'")->fetch(PDO::FETCH_ASSOC);
	...
	{
		$duzenlenecek_id = $_GET['id'];
		$ayar_kaydi = $db->query("SELECT * FROM slisliderbirder WHERE id = '$id'")->fetch(PDO::FETCH_ASSOC);
	...
	else
	{
	 ...
	 $simdi1 = $db->prepare("update sliderbir set adi=:adi,sira=:sira,resim=:resim,resim1=:resim1,buton=:buton,linki=:linki,durum=:durum,yazi1=:yazi1,yazi2=:yazi2,yazi3=:yazi3,yazi4=:yazi4,yazi5=:yazi5,aciklama=:aciklama where id=:id");
...
if($_GET['islem']=='duzenle'){
	...
	$guncelle = $db->query("select * from sliderbir where id='$gid'")->fetch(PDO::FETCH_ASSOC);
}
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Slider  Ekle</h5>
                                      <a href="sliderbir-listele.php"  class="btn btn-primary m-b-md">Slider Listele</a>
