...
$yeni =$sonid['id'];
    if(isset($_POST['img'])){
		...
		<div class='alert alert-warning alert-dismissible fade show' role='alert'>
                          <strong>Yorum Başarıyla Eklendi!</strong> 
...
if($_POST['kaydet'] and $_GET['islem']=='duzenle'){
	...
	if($ekle1){
		...
		<div class='alert alert-warning alert-dismissible fade show' role='alert'>
                          <strong>Yorum Başarıyla Güncellendi!</strong>
                          <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                        </div>
...
if($_GET['islem']=='duzenle'){
	...
	$guncelle = $db->query("select * from yorumlar where id='$gid'")->fetch(PDO::FETCH_ASSOC);
}
...
<head>
        ...
        <title>Add Comment | <?=$ayar['site_title']?></title>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Yorum  Ekle</h5>
                                      <a href="yorum-listele.php"  class="btn btn-primary m-b-md">Yorum Listele</a>
                                    <p class="card-description">Please fill all of the available spaces.</p>
                                    <?=$mesaj?>
                                    <form method="post" enctype="multipart/form-data" >
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" name="sira" placeholder="Comment Order" value="<?=$guncelle['sira']?>">
                                        <label for="floatingInput">Comment Order</label>
                                           ...
                                           <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" name="adi" placeholder="Comment Name" value="<?=$guncelle['adi']?>">
                                        <label for="floatingInput">Comment Name</label>
                                      </div>
								
									  
									  <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" name="kategori" placeholder="Ünvan" value="<?=$guncelle['kategori']?>">
