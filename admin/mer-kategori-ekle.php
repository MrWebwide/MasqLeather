...
$klasord="resimler/";
	...
	else
	{
	 ...
	 $simdi = $db->prepare("insert into mer_kategori set adi=:adi,sira=:sira,resim=:resim,kategori=:kategori,durum=:durum,onaciklama=:onaciklama,aciklama=:aciklama,seo=:seo,tur=:tur,eklenme_tarihi=:eklenme_tarihi");
	...
	if($ekle){
		  ...
		  $sonid=$db->query("select * from mer_kategori order by id desc")->fetch(PDO::FETCH_ASSOC);
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
									...
									<a href="mer-kategori-listele.php"  class="btn btn-primary m-b-md">Kategori Listele</a>
