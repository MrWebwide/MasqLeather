...
if (isset($_GET['islem']) && $_GET['islem'] == 'duzenle') {
    ...
    $stmt = $db->prepare("SELECT sira FROM urunler WHERE id = ?");
    ...
    $stmt = $db->query("SELECT MAX(sira) AS max_sira FROM urunler");
...
$query = $db->query("SELECT durum FROM urunler WHERE id='$id'");
                        ...
                        <div class="col">
                            <div class="card">
								...
								<h5 class="card-title">Add Product</h5>
								   ...
								   <a href="urun-listele.php"  class="btn btn-primary m-b-md">List Products</a> <!-- Ürünü kopyalamak için bir buton -->
...
document.getElementById("productCopy").addEventListener("click", function(event){
    ...
    xhr.open("GET", "copy_product_bag-purses.php?id=" + productId, true);
