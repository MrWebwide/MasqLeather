...
if($_GET['sil']){
	$idd=intval($_GET['sil']);
	 ...
	 $resim_sorgu=$db->query("select * from sliderdort where id='$idd'")->fetch(PDO::FETCH_ASSOC);
	 unlink('resimler/'.$resim_sorgu['resim']);
	$simdi=$db->query("delete from sliderdort where id='$idd'")->fetch(PDO::FETCH_ASSOC);
...
<link rel="icon" type="image/png" href="resimler/<?=$ayar['favicon']?>">
        ...
        <title>Slider Listele - <?=$ayar['site_title']?></title>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body table-responsive">
                                <h5 class="card-title">Slider Listele</h5>
                           
                                <a href="sliderdort-ekle.php"  class="btn btn-primary m-b-md">Slider Ekle</a>
                                <table class="table invoice-table ">
                                            <thead>
                                              <tr>
                                                <th scope="col">Slider Sırası</th>
                                            ...
                                            <tbody>
                                            <?php
                                            $urunlistele = $db->query("select * from sliderdort order by id desc",PDO::FETCH_ASSOC);
