...
if($_GET['sil']){
	$idd=intval($_GET['sil']);
	 ...
	 $resim_sorgu=$db->query("select * from jewe_kategori where id='$idd'")->fetch(PDO::FETCH_ASSOC);
	 unlink('../resimler/'.$resim_sorgu['resim']);
	$simdi=$db->query("delete from jewe_kategori where id='$idd'")->fetch(PDO::FETCH_ASSOC);
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="jewe-kat-ekle.php"  class="btn btn-primary m-b-md">Kategori Ekle</a>
                                <table class="table invoice-table">
                                            ...
                                            <tbody>
                                            <?php
                                            $urunlistele = $db->query("select * from jewe_kategori order by id desc",PDO::FETCH_ASSOC);
