                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="urun-kategori-ekle.php"  class="btn btn-primary m-b-md">Kategori Ekle</a>
                                <table class="table invoice-table">
                                            ...
                                            <tbody>
                                            <?php
                                            $urunlistele = $db->query("select * from urun_kategori order by id desc",PDO::FETCH_ASSOC);
