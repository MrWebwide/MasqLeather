...
imagedestroy($content);
	unlink ('../resimler/'.$resim1);
	 ...
	 $simdi = $db->prepare("insert into video set adi=:adi,sira=:sira,resim=:resim,linki=:linki,durum=:durum,aciklama=:aciklama");
	...
	if($ekle){
		...
		<div class='alert alert-warning alert-dismissible fade show' role='alert'>
                          <strong>Video Başarıyla Eklendi!</strong> 
...
unlink ('../resimler/'.$resim1);
	 ...
	 $simdi1 = $db->prepare("update video set adi=:adi,sira=:sira,resim=:resim,linki=:linki,durum=:durum,
	...
	if($ekle1){
		...
		<div class='alert alert-warning alert-dismissible fade show' role='alert'>
                          <strong>Video Başarıyla Güncellendi!</strong> 
                          <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                        </div>
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body" style="overflow:scroll;">
                                    <h5 class="card-title">Video  Ekle</h5>
                                        <a href="video-listele.php"  class="btn btn-primary m-b-md">Video Listele</a>
                                    ...
                                    <div class="form-floating mb-3">
                                        ...
                                        <label for="floatingInput">Video sırası</label>
                                      </div>
