...
<head>
        ...
        <title>Referans Listele | <?=$ayar['site_title']?></title>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body" style="overflow:scroll">
                                <h5 class="card-title">Referans Listele</h5>
                           
                                <a href="haber-ekle.php"  class="btn btn-primary m-b-md">Referans Ekle</a>
                                <table class="table invoice-table">
                                            <thead>
                                              <tr>
                                                <th scope="col">Referans Sırası</th>
                                                <th scope="col">Referans Resmi</th>
                                            ...
                                            <tbody>
                                            <?php
                                            $urunlistele = $db->query("select * from haberler order by sira asc",PDO::FETCH_ASSOC);
											...
											?>
                                              <tr data-id="<?=$urungoster['id']?>" data-oldorder="<?=$urungoster['sira']?>">
                                                ...
                                                <td><img src="resimler/<?=$urungoster['resim']?>" alt="<?=$urungoster['yazi1']?>">  </td>
                                                ...
                                                <td>
                                                  ...
                                                  <a href="../referanslar.php" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg></a>
    ...
    <?php $reorderTable='haberler'; include("include/reorder_script.php"); ?>
    </body>
