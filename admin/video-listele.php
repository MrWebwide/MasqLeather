            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Video Listele</h5>
                           
                                <a href="video-ekle.php"  class="btn btn-primary m-b-md">Video Ekle</a>
                                <table class="table invoice-table">
                                            <thead>
                                              <tr>
                                                <th scope="col">Video Sırası</th>
                                                <th scope="col">Video Resmi</th>
                                            ...
                                            <tbody>
                                            <?php
                                            $videolistele = $db->query("select * from video order by id desc",PDO::FETCH_ASSOC);
											if($videolistele->rowCount()){foreach($videolistele as $videogoster){
											?>
                                              <tr>
                                                ...
                                                <td>
                                                  <a href="video-ekle.php?islem=duzenle&id=<?=$videogoster['id']?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></a>
                                                  
                                                  <a clas="silmeAlani"href="?sil=<?=$videogoster['id']?>"><i class="fa fa-trash-o"></i></a>
                                                </td>
                                              </tr>
