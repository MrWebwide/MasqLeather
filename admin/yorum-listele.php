...
<head>
        ...
        <title>Yorum Listele | <?=$ayar['site_title']?></title>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body" style="overflow:scroll">
                                <h5 class="card-title">Yorum Listele</h5>
                           
                                <a href="yorum-ekle.php"  class="btn btn-primary m-b-md">Add Comment</a>
                                <table class="table invoice-table">
                                            ...
                                            <tbody>
                                            <?php
                                            $urunlistele = $db->query("select * from yorumlar order by sira asc",PDO::FETCH_ASSOC);
    ...
    <?php $reorderTable='yorumlar'; include("include/reorder_script.php"); ?>
          </body>
