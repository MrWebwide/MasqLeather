...
if($_GET['sil']){
	$idd=intval($_GET['sil']);
	 ...
	 $resim_sorgu=$db->query("select * from bloglar where id='$idd'")->fetch(PDO::FETCH_ASSOC);
	 unlink('resimler/'.$resim_sorgu['resim']);
	$simdi=$db->query("delete from bloglar where id='$idd'")->fetch(PDO::FETCH_ASSOC);
...
<head>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body"style="overflow:scroll">
                                ...
                                <a href="blog-ekle.php"  class="btn btn-primary m-b-md">Add Blog</a>
                                <table class="table invoice-table">
                                            ...
                                            <tbody>
                                            <?php
                                            $urunlistele = $db->query("select * from bloglar order by sira asc",PDO::FETCH_ASSOC);
    ...
    <?php $reorderTable='bloglar'; include("include/reorder_script.php"); ?>
    </body>
