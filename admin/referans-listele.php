...
<head>
        ...
        <title>Köfte Menü Yönetimi - <?=$ayar['site_title']?></title>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body table-responsive">
                                <h5 class="card-title">Köfte Menü Yönetimi</h5>
                                <a href="referans-ekle.php"  class="btn btn-primary m-b-md">Köfte Menü Ekle</a>
                              
                                <table class="table invoice-table">
                                            <thead>
                                              <tr>
                                                <th scope="col">Köfte Menü Sırası</th>
                                              
                                                <th scope="col">Köfte Menü Adı</th>
                                            ...
                                            <tbody>
                                            <?php
                                            $urunlistele = $db->query("select * from referanslar order by id desc",PDO::FETCH_ASSOC);
