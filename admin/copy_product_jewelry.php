...
$statement = $db->prepare("SELECT * FROM jewe WHERE id = :id");
$statement->bindParam(':id', $productId);
$statement->execute();
$product = $statement->fetch(PDO::FETCH_ASSOC);

// Yeni bir ürün girişi oluşturuyoruz
$newProductStatement = $db->prepare("INSERT INTO jewe (adi, sira, resim, resim1, kategori, durum, onaciklama, aciklama, seo, yazi1, yazi3, yazi2, yazi4, yazi5, yazi6, yazi7, yazi8,yazi9, cargo, stock, cargo_us, tur, eklenme_tarihi) VALUES (:adi, :sira, :resim, :resim1, :kategori, :durum, :onaciklama, :aciklama, :seo, :yazi1, :yazi3, :yazi2, :yazi4, :yazi5, :yazi6,:yazi7,:yazi8,:yazi9, :cargo, :stock, :cargo_us, :tur, NOW())");
...
$cek = $db->prepare("SELECT * FROM jewe_img WHERE urun_id = :id");
...
foreach ($resimler as $resim) {
    $ekle = $db->prepare("INSERT INTO jewe_img (urun_id, img) VALUES (:urun_id, :img)");
