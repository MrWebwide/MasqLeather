...
<head>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="galeri-ekle.php"  class="btn btn-primary m-b-md">Galeri Ekle</a>
                                <table class="table invoice-table">
                                            <thead>
                                              <tr>
                                                <th scope="col">Galeri Sırası</th>
                                                <th scope="col">Galeri Resmi</th>
                                                <th scope="col">Galeri Adı</th>
                                            ...
                                            <tbody>
                                            <?php
                                            $urunlistele = $db->query("select * from galeri order by sira asc",PDO::FETCH_ASSOC);
    ...
    <?php $reorderTable='galeri'; include("include/reorder_script.php"); ?>
    </body>
