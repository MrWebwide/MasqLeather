...
if($_GET['sil']){
	$idd=intval($_GET['sil']);
	 ...
	 $resim_sorgu=$db->query("select * from new where id='$idd'")->fetch(PDO::FETCH_ASSOC);
	 unlink('resimler/'.$resim_sorgu['resim']);
	$simdi=$db->query("delete from new where id='$idd'")->fetch(PDO::FETCH_ASSOC);
...
<head>
        ...
        <title>New Products Listele | <?=$ayar['site_title']?></title>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body"style="overflow:scroll">
                                ...
                                <a href="new-ekle.php"  class="btn btn-primary m-b-md">New Products Ekle</a>
                                <table class="table invoice-table">
                                            <thead>
                                              <tr>
                                                <th scope="col">New Products Sırası</th>
                                               
                                                <th scope="col">New Products Adı</th>
                                                <th scope="col">New Products Resmi</th>
                                            ...
                                            <tbody>
                                            <?php
                                            $urunlistele = $db->query("select * from new order by sira asc",PDO::FETCH_ASSOC);
    ...
    <?php $reorderTable='new'; include("include/reorder_script.php"); ?>
    </body>
