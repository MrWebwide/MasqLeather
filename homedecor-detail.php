...
<body>
    ...
    <div class="product-section" style="padding-left: 15vw;">
        ...
        <?php
$haberg = $db->query("SELECT * FROM bloggelen WHERE durum = 'on' AND yorumid = $id AND tur = 'homedecor' ORDER BY id DESC");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($_POST['comment']) && !empty($_POST['author']) && !empty($_POST['email'])) {
        ...
        $tur = 'homedecor'; // Eklemek istediğiniz değer

        // Veritabanına veri eklemek için bir sorgu hazırlayın
                        ...
                        <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                            ...
                            <div class="addreview">
                                ...
                                <div class="product_review_form">
                                    <form method="post" action="" id="comment-form3" data-tur="homedecor" novalidate>
                                        <div class="row">
                            ...
                            <article class="single_product">
                                <figure>
                                    <div class="product_thumb">
                                        <a href="homedecor-detail.php?id=<?= $hizmet['id'] ?>"><img
                                                src="admin/resimler/<?=$hizmet['resim']?>" alt=""></a>

                                    </div>
                                    <figcaption class="product_content">
                                        <h4><a href="homedecor-detail.php?id=<?= $hizmet['id'] ?>">
                                                <?=$hizmet['adi']?>
                                            </a></h4>
                                        <div class="price_box">
                                            <span class="current_price">$
