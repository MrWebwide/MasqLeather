...
$pageTitle       = $yazi['yazi2'] ?? 'Blog';
$pageDescription = $yazi['hizmetvideoyazi'] ?? '';
$pageKeywords    = $yazi['yorumyazi'] ?? '';
?>
<!DOCTYPE html>
    ...
    <section class="blog_page_section">
        <div class="container-fluid">
            <div class="row no-gutters">
                <div class="col-12">
                <?php
$hizmett = $db->query("SELECT * FROM bloglar");
$count = 0;
    ...
    <div class="blog_list <?= ($class_order == 'left') ? 'blog_list_bg' : '' ?>">
        <div class="single_blog_page d-flex align-items-center justify-content-between">
            ...
            <?php } ?>
                ...
                <h3 class="wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="1.2s"><a href="blog-details.php?id=<?= $hizmet['id'] ?>"><?= $hizmet['adi'] ?></a></h3>
                <p class="wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="1.3s"><?= $hizmet['onaciklama'] ?></p>
                <a class="btn btn-link wow fadeInUp" href="blog-details.php?id=<?= $hizmet['id'] ?>.html" data-wow-delay="0.4s" data-wow-duration="1.4s">Read more</a>
            </div>
