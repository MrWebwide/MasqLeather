...
?>
<?php
$pageTitle = 'Privacy Policy - Masq Leather';
$pageDescription = 'Masq Leather privacy policy. Learn how we collect, use, and protect your personal information.';
$noExzoom = true;
?>
<!DOCTYPE html>
                    ...
                    <div class="col-lg-12">
                        <div class="contact_info">
                            <div class="contact_info_title text-center">
                                <h3 class="wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1.1s"><?=$sayac4['sayi1']?></h3>
                            </div>
                           
                        </div>
                    </div>
                    <div class="col-lg-12 text-center" >
                        <div class="contact_form wow fadeInUp text-center" data-wow-delay="0.1s" data-wow-duration="1.1s"> 
                                <p>				         
