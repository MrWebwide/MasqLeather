...
?>
<?php
$pageTitle = 'Shipping Policy - Masq Leather';
$pageDescription = 'Masq Leather shipping policy. Learn about shipping methods, delivery times, and costs.';
$noExzoom = true;
?>
<!DOCTYPE html>
                    ...
                    <div class="col-lg-12">
                        <div class="contact_info">
                            <div class="contact_info_title text-center">
                                <h3 class="wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1.1s">  <?=$sayac7['sayi1']?>
</h3>
                            </div>
