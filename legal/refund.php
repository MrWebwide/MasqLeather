...
?>
<?php
$pageTitle = 'Refund Policy - Masq Leather';
$pageDescription = 'Masq Leather refund and return policy. Learn about our refund process and conditions.';
$noExzoom = true;
?>
<!DOCTYPE html>
                    ...
                    <div class="col-lg-12">
                        <div class="contact_info">
                            <div class="contact_info_title text-center">
                                <h3 class="wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1.1s"><?=$sayac6['sayi1']?></h3>
                            </div>
